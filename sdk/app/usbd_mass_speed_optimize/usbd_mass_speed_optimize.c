        ...
        if(ptr){
            ...
            case READ_FLAG:           
                if(dev->error_flag == 0)
                {
                    if(multi_sector_en)
                    {
                        ret = dev->udisk_read(dev->storage_dev, lba,calc_optimize_sec,buff);
                    }
                    else
                    {
                        ret = dev->udisk_read(dev->storage_dev, lba,1,buff);
                    }
                }
            ...
            case WRITE_FLAG:
                ...
                if(dev->error_flag == 0)
                {
                    ...
                    if(multi_sector_en)
                    {
                        ret = dev->udisk_write(dev->storage_dev, lba,calc_optimize_sec,buff);
                    }
                    else
                    {
                        ret = dev->udisk_write(dev->storage_dev, lba,1,buff);
                    }
                }
