...
/*Use TXW82x's DMA2D GPU*/
#define LV_USE_GPU_TXW82X_DMA2D 1
...
#if LV_USE_FS_VFS
    #define LV_FS_VFS_LETTER 'V'     /*Set an upper cased letter on which the drive will accessible (e.g. 'A')*/
    #define LV_FS_VFS_CACHE_SIZE 0    /*>0 to cache this number of bytes in lv_fs_read()*/
#endif
